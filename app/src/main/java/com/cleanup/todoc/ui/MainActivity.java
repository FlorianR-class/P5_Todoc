...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Rotation Ecran "getInt sortMethod"
        ...
        this.getProjects();
        this.getTasks();
        Stetho.initializeWithDefaults(this); // Database Inspection with Chrome browser (chrome://inspect)
    ...
    // Rotation Ecran "putInt sortMethod" ----------------------------------
    @Override
    protected void onSaveInstanceState(Bundle outState) {
        super.onSaveInstanceState(outState);
        outState.putInt("sortMethod", sortMethod.ordinal());
    }
    ...
    private void getProjects(){
        assert this.taskViewModel.getProjects() != null;
